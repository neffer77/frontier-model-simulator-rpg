...
try{
  ...
  desktop=await phase('create-desktop-context',()=>browser.newContext({viewport:{width:1440,height:1000}));const d=activePage=await phase('create-desktop-page',()=>desktop.newPage());d.setDefaultTimeout(8000);d.setDefaultNavigationTimeout(12000);d.on('pageerror',e=>errors.push(String(e?.stack||e)));
