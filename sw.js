const CACHE='frontier-lab-v1';
const CORE=[
  './','./index.html','./styles.css','./mobile-ux.css','./responsive-gameplay-shell.css',
  './frontier-lab.js','./runtime-compat.js','./responsive-gameplay-shell.js',
  './ui-components.js','./progressive-disclosure.js','./story-integration.js','./app-experience.css',
  './manifest.webmanifest','./frontier-lab-icon.svg'
];
