...
// Canonical application metadata and launch/deep-link contract shared by phone and desktop shells.
(function(){
  'use strict';
  const SCHEMA=1;
  ...
  const APPS=[
    ...
    {id:'model-lab',label:'Model Lab',shortLabel:'Lab',icon:'⚗',category:'research',route:'os/model-lab',aliases:['lab','research'],status:'ready',command:'model.lab.native.open',surfaces:['phone','desktop'],window:{width:1100,height:760,minWidth:600,minHeight:460},description:'Architecture experiments, ablations, lineage, and persistent model memory.'},
    ...
    {id:'data',label:'Data Explorer',shortLabel:'Data',icon:'▤',category:'engineering',route:'os/data',aliases:['datasets','shards'],status:'ready',command:'data.explorer.open',surfaces:['phone','desktop'],window:{width:1040,height:720,minWidth:560,minHeight:440},description:'Dataset mixtures, shards, provenance, dedup, tokenizer cost, and replay evidence.'},
    {id:'team',label:'People',shortLabel:'Team',icon:'☺',category:'company',route:'os/team',aliases:['people','employees','npc'],status:'ready',command:'team.open',surfaces:['phone','desktop'],window:{width:980,height:700,minWidth:520,minHeight:420},badge:'team',description:'Employees, expertise, delegation, hiring and organizational memory.'},
    {id:'projects',label:'Projects',shortLabel:'Projects',icon:'▦',category:'company',route:'os/projects',aliases:['portfolio','programs','roadmap'],status:'ready',legacy:['projectPortfolioOpen','programManagementOpen'],surfaces:['phone','desktop'],window:{width:1080,height:740,minWidth:580,minHeight:440},unlock:'started',description:'Programs, portfolio, critical paths, commitments and roadmap work.'},
    {id:'company',label:'Company',shortLabel:'Company',icon:'⌂',category:'company',route:'os/company',aliases:['home','dashboard'],status:'ready',command:'navigation.home.open',surfaces:['phone','desktop'],window:{width:1120,height:760,minWidth:600,minHeight:460},unlock:'started',description:'Company dashboard, milestones, strategy and operational status.'},
    {id:'finance',label:'Finance',shortLabel:'CFO',icon:'$',category:'company',route:'os/finance',aliases:['cfo','funding','runway'],status:'ready',legacy:['financingStrategyOpen','investmentCommitteeOpen'],surfaces:['phone','desktop'],window:{width:1040,height:720,minWidth:560,minHeight:420},unlock:'started',description:'Runway, financing, investment decisions and company economics.'},
    {id:'knowledge',label:'Knowledge',shortLabel:'Learn',icon:'?',category:'learning',route:'os/knowledge',aliases:['curriculum','learning','mastery'],status:'ready',legacy:['knowledgeOpen'],surfaces:['phone','desktop'],window:{width:980,height:720,minWidth:520,minHeight:420},description:'Concept mastery, explainers, curriculum and career learning.'},
    {id:'artifacts',label:'Artifacts',shortLabel:'Files',icon:'□',category:'engineering',route:'os/artifacts',aliases:['files','engineering-artifacts'],status:'ready',legacy:['engineeringArtifactsOpen','artifactOpen'],surfaces:['phone','desktop'],window:{width:980,height:700,minWidth:520,minHeight:420},unlock:'started',description:'Engineering artifacts, reports, postmortems and technical records.'},
